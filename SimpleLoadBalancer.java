...
public class SimpleLoadBalancer extends BaseLoadBalancer {
  ...
  public List<RegionPlan> balanceCluster(
    ...
    LOG.info("Before Simple Balancing");
    LOG.info("Key Set:" + serversByLoad.keySet());
    for (ServerAndLoad server : serversByLoad.keySet()) {
      LOG.info("---------------" + "Server Name: " + server.getServerName() + "---------------");
      LOG.info("List of Regions:" + serversByLoad.keySet());
      ...
      for (HRegionInfo hRegionInfo : hRegionInfos){
        LOG.info("Belongs to Table: " + hRegionInfo.getTable());
    ...
    for (Map.Entry<ServerAndLoad, List<HRegionInfo>> server:
      ...
      //LOG.info("Server: " + server.getServerName() + "Key" + server.getKey());
    }
